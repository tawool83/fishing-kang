...
## 1-6. 단톡방 링크 미리보기 (OG 카드) — **완료 (2026-09-23 실물 확인)**
...
**2026-09-23 — 실제 카카오톡에서 썸네일까지 정상 표시 확인.** 문구나 이미지를 고치면
카톡이 이전 스크랩 결과를 캐시하므로 [카카오 개발자 도구](https://developers.kakao.com/tool/clear/og)에서
캐시를 지우고 다시 붙여야 한다.
